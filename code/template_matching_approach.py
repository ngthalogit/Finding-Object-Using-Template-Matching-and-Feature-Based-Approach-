...
if __name__ == '__main__':
    ...
    gallary = cv.imread(path + "/Gallery/gal2.jpeg")
    ...
    # find the region taking the largest correlations coefficient with resized template
    m = METHODS[5]
    med = eval(m)
    performances = []
    for sh in scale_h:
    ...
    cv.imwrite(path + "/Outputs/" + m + "/output22.png", gallary_copy)
